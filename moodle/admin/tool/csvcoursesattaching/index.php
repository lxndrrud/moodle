...
$returnurl = new moodle_url('/admin/tool/csvcoursesattaching/index.php');

$form = new csv_upload_form();
if ($formdata = $form->get_data()) {
    $importid = csv_import_reader::get_new_iid('csvcoursesattaching');
    $cir = new csv_import_reader($importid, 'csvcoursesattaching');
    ...
    */
    ...
    echo $OUTPUT->header();
    echo $OUTPUT->heading_with_help(get_string('csvcoursesattaching', 'tool_csvcoursesattaching'), 'csvcoursesattaching', 'tool_csvcoursesattaching');
    $form->display();
    echo $OUTPUT->footer();
    die();
}
